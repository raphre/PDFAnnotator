...
//  PDFAnnotator
//
//  Created by Raphael Reyna on 7/22/18.
...
public extension UIDevice {
    ...
    func hasApplePencil() -> Bool {
        let modelString = modelName as NSString
        return modelString.contains("Pro")
    }
}

func makeCenteredFrame(pageSize: CGSize, superRect: CGRect) -> CGRect {
...
func getSamplePDFDocument() -> PDFDocument {
